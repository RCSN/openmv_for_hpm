...
QDEF(MP_QSTR_AF1_PWM3, (const byte*)"\xf5\x83\x08" "AF1_PWM3")
...
QDEF(MP_QSTR_AF4_TMR2, (const byte*)"\x30\x9c\x08" "AF4_TMR2")
...
QDEF(MP_QSTR_P10, (const byte*)"\x14\x09\x03" "P10")
...
QDEF(MP_QSTR_DCMC, (const byte*)"\xec\x14\x04" "DCMC")
...
QDEF(MP_QSTR_QTIMER, (const byte*)"\x73\x7e\x06" "QTIMER")
QDEF(MP_QSTR_RPM, (const byte*)"\x2a\x05\x03" "RPM")
QDEF(MP_QSTR_SD, (const byte*)"\xf2\x74\x02" "SD")
QDEF(MP_QSTR_SDCard, (const byte*)"\xa6\xaf\x06" "SDCard")
QDEF(MP_QSTR_SEC_COUNT, (const byte*)"\x0c\x57\x09" "SEC_COUNT")
QDEF(MP_QSTR_SEC_SIZE, (const byte*)"\xaa\x86\x08" "SEC_SIZE")
...
QDEF(MP_QSTR_SRPM, (const byte*)"\xf9\x37\x04" "SRPM")
QDEF(MP_QSTR_SWIM, (const byte*)"\x05\x3a\x04" "SWIM")
QDEF(MP_QSTR_SYNC, (const byte*)"\xe2\x62\x04" "SYNC")
...
QDEF(MP_QSTR_erro, (const byte*)"\xef\x93\x04" "erro")
...
QDEF(MP_QSTR_get_pps, (const byte*)"\x3f\x9c\x07" "get_pps")
QDEF(MP_QSTR_get_rpm, (const byte*)"\x23\x94\x07" "get_rpm")
QDEF(MP_QSTR_get_spps, (const byte*)"\x6c\xd9\x08" "get_spps")
QDEF(MP_QSTR_get_srpm, (const byte*)"\x70\xe1\x08" "get_srpm")
...
QDEF(MP_QSTR_interval, (const byte*)"\x1a\x0e\x08" "interval")
...
QDEF(MP_QSTR_pprparam, (const byte*)"\xd8\xde\x08" "pprparam")
QDEF(MP_QSTR_prescale, (const byte*)"\x1a\xd2\x08" "prescale")
...
QDEF(MP_QSTR_pwm_freq, (const byte*)"\xf0\x03\x08" "pwm_freq")
QDEF(MP_QSTR_pwm_inverted, (const byte*)"\x03\x1e\x0c" "pwm_inverted")
QDEF(MP_QSTR_pwm_width, (const byte*)"\xd6\xfc\x09" "pwm_width")
...
QDEF(MP_QSTR_SET_READOUT_WINDOW, (const byte*)"\xb7\x40\x12" "SET_READOUT_WINDOW")
QDEF(MP_QSTR_GET_READOUT_WINDOW, (const byte*)"\x23\xae\x12" "GET_READOUT_WINDOW")
