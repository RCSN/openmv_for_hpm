...
Q(SET_READOUT_WINDOW)

Q(GET_READOUT_WINDOW)
...
Q(set_vsync_callback)

Q(set_frame_callback)

Q(VIDEO_FIFO)

Q(disable_full_flush)
...
Q(IOCTL_TRIGGER_AUTO_FOCUS)

Q(IOCTL_PAUSE_AUTO_FOCUS)

Q(IOCTL_RESET_AUTO_FOCUS)

Q(IOCTL_WAIT_ON_AUTO_FOCUS)